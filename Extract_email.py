...
class Dataset_Creation:
    ...
    def generate_csv_file(self, valid_emails):
        ...
        file = open('/home/leo/Desktop/Learnspace/NLP/Email-Classifier/Datasets/final_dataset.csv','w')
...
emails_dataset = open('/home/leo/Desktop/Learnspace/NLP/Email-Classifier/Datasets/fradulent_emails.txt','r').read() #Read complete dataset as string
...
emails_dataset2 = open('/home/leo/Desktop/Learnspace/NLP/Email-Classifier/Datasets/spam_normal_emails.csv','r').readlines() #Read complete dataset as string
